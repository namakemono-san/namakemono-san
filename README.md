# 👋 Hey there! I'm namakemono

I'm just a student who enjoys programming as a hobby and mainly builds tools that make my workflow and environment more convenient.  
I work on things like Modding, creating plugins, small desktop and mobile tools, and whatever other utilities I feel I need in my daily workflow.
...
- **Java (Paper / Velocity / Plugin Development)**
- **Rust (Tauri Desktop Apps / API Development)**
- **Go (Echo API Development)**
- **Electron (occasional use)**
- **MariaDB / MongoDB / Redis / Supabase**
- **Proxmox / Docker / Grafana**
